...
import RatingRadioGrid from './RatingRadioGrid';
...
const RatingRowGrid = ({question, question_id, value, setValue}) => {
  return (
    <div className='grid-row'>
      <div className='grid-cell'>{question}</div>
      <RatingRadioGrid
